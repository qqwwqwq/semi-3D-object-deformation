...
def fps(name,ns):
    ...
    parser.add_argument("--data", type=str, default=name,
                        help="Load some points data, choices are \"bunny\", \"circle\", \"eclipse\", "
                             "or \"a_path_to_your_ply_file\".")
    parser.add_argument("--n_samples", type=int, default=ns, help="Number of samples we would like to draw.")
    ...
    if manually_step is False:
        ...
        print(np.asarray(pcd_selected.points),111111)
        # return np.asarray(pcd_selected.points),np.asarray(pcd_all.points)
...
# fps("/Users/apple/Desktop/11.13/w22.ply",10)
